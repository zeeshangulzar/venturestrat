...
export default function AdminInvestorShowPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (urlFilters || urlPage) {
        ...
        setBackUrl(url);
        console.log('Created admin back URL:', url);
      }
    }
  }, []);
  ...
  return (
    <div className="mx-auto max-w-6xl p-6">
      {/* Admin Page Header */}
      <div className="mb-6 border-b border-[#EDEEEF] pb-4">
        <h1 className="text-2xl font-bold text-slate-900">Admin - Investor Details</h1>
        <p className="text-gray-600 mt-2">Viewing investor information in admin panel</p>
      </div>
