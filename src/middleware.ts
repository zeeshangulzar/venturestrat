...
const isProtectedRoute = createRouteMatcher(['/investor(.*)', '/onboarding'])
const isPublicRoute = createRouteMatcher(['/sign-in', '/sign-up', '/sso-callback', '/privacy-policy', '/terms-and-conditions', '/home'])
