        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            {readOnly ? (
              ...
              <div className='flex items-center gap-2 w-full text-lg font-semibold border bg-[#F6F9FE] border-[#EDEEEF]  px-3 py-2 focus:outline-none rounded-[10px]'>
                <input
                  type="text"
                  value={editedSubject}
                  onChange={(e) => handleFieldChange('subject', e.target.value)}
                  className="not-italic font-bold text-[16px] leading-[16px] tracking-[-0.02em] capitalize text-[#0C2143]"
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16.333 10L12.9997 13.3333" stroke="white" stroke-width="1.5" stroke-linecap="round" strokeLinejoin="round"/>
